...
# The `libxrk.aim_xrk` attribute is the function; reach the module explicitly.
aim_xrk_mod = importlib.import_module("libxrk.aim_xrk")
...
def _decoded_timecodes(timecodes) -> list:
    ...
    channels = aim_xrk_mod._decode_gps(blob, 0)
