...
//!
//! Usage: cargo run --profile profiling --bin bench_parse -- <xrk_file> [iterations]
//! Profiling: samply record -- cargo run --profile profiling --bin bench_parse -- <xrk_file> 50

use std::time::Instant;

use _aim_xrk_rs::gps_processing;
use _aim_xrk_rs::parser;
...
fn main() {
    ...
    for _ in 0..2 {
        ...
        let _ = gps_processing::decode_gps(&result.gps_data, result.time_offset);
